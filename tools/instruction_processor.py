...
class InstructionProcessor:
    def __init__(
        self, 
        model_api_base: str = "http://localhost:8015/v1", 
        model_name: str = "/home/zirui/.cursor-server/Qwen2.5-VL-FT-Remote/export_v5_11968", 
...
if __name__ == "__main__":
    ...
    processor = InstructionProcessor(
        model_api_base="http://localhost:8015/v1",
        model_name="/home/zirui/.cursor-server/Qwen2.5-VL-FT-Remote/export_v5_11968",
